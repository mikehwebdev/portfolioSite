...
},
{
    ...
    subItems: [{
        subHeader: "Customer Experience Advisor",
        subHeaderDetail: "Evander - Norwich",
        date: "February 2024 - Current",
        text: ["Key responsibilities"],
        list: ["Conducting initial triage calls to new customers", "Managing a body of existing claimants", "Declining claims and managing complaints", "Liaising with Insurance companies to progress claims", "Achieve sales and upgrade targets"],
        toggled: false,
        id: 0
    }, {
        subHeader: "Loader",
        ...
        subHeader: "Customer Service Manager",
...

{
    ...
    list: ["Watching films (horror for preference)", "Playing video games", "Drinking real ales", "Web-development (nerd - I know)", "Reading", "Music", "Swimming", "Writing short stories"]
}
]
